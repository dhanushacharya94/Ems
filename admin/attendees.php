		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT a.*,concat(a.firstname,' ',a.middlename,' ',a.lastname) as name,e.event FROM attendees a inner join events e on e.id = a.event_id order by unix_timestamp(e.date_created) desc ");
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      ...
		                      <a href="./index.php?page=edit_attendee&id=<?php echo $row['id'] ?>" class="dropdown-item" >Edit</a>
		                      <div class="dropdown-divider"></div>
