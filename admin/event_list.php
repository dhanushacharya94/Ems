					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a href="./index.php?page=view_event&id=<?php echo $row['id'] ?>" class="dropdown-item view_user" >View</a>
		                      <div class="dropdown-divider"></div>
		                      <a href="./index.php?page=edit_event&id=<?php echo $row['id'] ?>" class="dropdown-item" >Edit</a>
		                      <div class="dropdown-divider"></div>
		                      <a class="btn btn-danger btn-flat delete_event dropdown-item delete_user" data-id="<?php echo $row['id'] ?>">Delete</a>
		                    </div>
						</td>
