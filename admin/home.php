          ...
          <div class="col-12 col-sm-6 col-md-5">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><b>Total Supervisor</b></span>
          ...
          <!-- /.col -->
           <div class="col-12 col-sm-6 col-md-5">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><b>Total Events</b></span>
                <span class="info-box-number">
...
<?php else: ?>
	 <div class="col-12">
          <div class="card">
          	<div class="card-body">
          		<b>Welcome to our Events Management System <?php echo $_SESSION['login_name'] ?>! </b>
          	</div>
          </div>
      </div>
