		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-outline card-primary">
					...
					<div class="card-body">
						<?php if($status == 2): ?>
							<div class="alert alert-info"><i class="fa fa-info-circle"></i> Event's Registration is now close. </div>
						<?php endif; ?>
						<table class="table table-bordered">
							...
							<?php
							$i = 1;
							$qry = $conn->query("SELECT a.*,concat(a.firstname,' ',a.middlename,' ',a.lastname) as name,e.event FROM attendees a inner join events e on e.id = a.event_id where e.id = $id order by unix_timestamp(e.date_created) desc ");
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a class="btn btn-info btn-flat view_attendee dropdown-item view_user" data-id="<?php echo $row['id'] ?>">View</a>
		                      <div class="dropdown-divider"></div>
		                      <a data-id="<?php echo $row['id'] ?>" class="btn btn-primary btn-flat edit_attendee dropdown-item" >Edit</a>
		                      <div class="dropdown-divider"></div>
		                      <a class="btn btn-danger btn-flat dropdown-item delete_attendee" data-id="<?php echo $row['id'] ?>">Delete</a>
		                    </div>
