    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-is-tree nav-edit_event nav-view_event">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_event" class="nav-link nav-new_event tree-item">
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=attendees" class="nav-link nav-attendees nav-edit_attendee nav-new_attendee nav-view_attendee">
