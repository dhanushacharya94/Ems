...
<div class=" col-lg-7">
  <div class="register-logo">
    <a href="#"><b>Event Management System</b></a>
  </div>
<?php session_start() ?>
...
?>
  <div class="card">
    <div class="card-body register-card-body">
      <h4 class="text-center">CREATE YOUR ACCOUNT</h4><?php echo !isset($id) ? 'Create Account' : 'Manage Account'; ?></p>
      <form id="manage_user">
	      ...
	      <div class="col-md-12">
	      	<div class="row">
			        ...
			        <div class="mb-3">
			          <textarea cols="120" rows="2" class="form-control" name="address" required placeholder="Address"><?php echo isset($address) ? $address : '' ?></textarea>
			        </div>
	      			<div class="input-group mb-3">
